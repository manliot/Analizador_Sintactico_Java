...
CYCL_FOR:  FOR PARENT_A DECLARACION PUNTOYCOM ID OPERADORES_REL DIMENSION PUNTOYCOM ASIGNACION PARENT_C LLAVE_A INSTRUCCIONES LLAVE_C 
          |FOR PARENT_A ID OP_ASIG OPERACION_MATH PUNTOYCOM ID OPERADORES_REL DIMENSION PUNTOYCOM ASIGNACION PARENT_C LLAVE_A INSTRUCCIONES LLAVE_C 
          ;
...
COLUMNAS: LLAVE_A COLUMNAS COMA COLUMNAS LLAVE_C      
          |  COLUMNA;                             
...
FILA:  CONSTANTES COMA FILA       
        | CONSTANTES ;        
CONDICIONALES: CONDICIONALES OPERADORES_LOGICOS CONDICIONALES
              |CONDICIONAL;
...
DECL_VARIABLE: ASIGNACION
              ...
              |NOM_ARRAY
              |ASIGNACION_ARRAY;
ASIGNACION: ID ASIG_SYMBOLS OPERACION_MATH 
            | ID OP_ASIG CTE_CAD 
            | ID INCREMENTO_SYMBOLS;  

ASIGNACION_ARRAY: NOM_ARRAY ASIGNACION_ARRAY_RIGHT;

ASIGNACION_ARRAY_RIGHT: OP_ASIG NEW TIPO_VAR CORCHET_A CTE_ENT CORCHET_C CORCHET_A DIMENSION CORCHET_C
